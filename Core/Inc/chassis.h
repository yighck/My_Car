...
/* ========== Chassis Parameters ========== */
#define CHASSIS_WHEEL_TRACK   0.150f  /* Wheel track (m) - left to right */
#define CHASSIS_WHEEL_BASE    0.150f  /* Wheel base (m)  - front to back */
#define CHASSIS_WHEEL_RADIUS  0.035f  /* Wheel radius (m) - adjust to your wheel */
